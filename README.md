...
Ora è necessario sapere il chatID dell'utente, per ottenere questo serve mandare un messaggio al bot telegram appena creato e visitare [https://api.telegram.org/bot<TOKEN>/getUpdates
](https://api.telegram.org/bot<TOKEN>/getUpdates), dove <TOKEN> è il token fornito da BotFather. Nella risposta JSON, annotare il numero nel campo "id".  
